...
package org.apache.guacamole.auth.privacyidea.form;
...
public class AuthenticationCodeField extends Field {
     ...
     */
    public static final String PARAMETER_NAME = "guac-privacyidea";

    /**
     * The unique name associated with this field type.
     */
    private static final String FIELD_TYPE_NAME = "GUAC_PRIVACYIDEA_CODE";

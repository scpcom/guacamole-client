...
/**
 * PrivacyIDEA-specific User implementation which wraps a User from another extension,
 * hiding and blocking access to the core attributes used by PrivacyIDEA.
 */
public class PrivacyIDEAUser extends DelegatingUser {
    ...
    /**
     * The name of the user attribute which stores the transactionID.
     */
    public static final String PRIVACYIDEA_TRANSACTION_ID_ATTRIBUTE_NAME = "guac-privacyidea-transaction-id";
     ...
     */
    public static final Form PRIVACYIDEA_CONFIG_FORM = new Form("privacyidea-config-form",
            Arrays.asList(
     ...
     * attributes used by PrivacyIDEA.
     *
     * @param user
     *     The User object to wrap.
     */
    public PrivacyIDEAUser(User user) {
        super(user);
    }

    /**
     * Returns the User object wrapped by this PrivacyIDEAUser.
     *
     * @return
    ...
    public Map<String, String> getAttributes() {
        ...
        String transactionID = attributes.remove(PRIVACYIDEA_TRANSACTION_ID_ATTRIBUTE_NAME);
    ...
    public void setAttributes(Map<String, String> attributes) {
        ...
        attributes.remove(PRIVACYIDEA_TRANSACTION_ID_ATTRIBUTE_NAME);
        ...
        if (reset != null && reset.equals("true")) {
            ...
            attributes.put(PRIVACYIDEA_TRANSACTION_ID_ATTRIBUTE_NAME, null);
